...
for i in range(0,2000,200):
    ...
    for i in range(2,33):
        XY(N,3,'Planexy_{}'.format(i),i,'e11')
    
    savetxt('xy{}({}) {}kV.dat'.format(N,fO,eF), coordinates, fmt='%4d')
    np.save("xy{}({}) {}kV".format(N,fO,eF), coordinates)
    
# R=3 (e11),10(e22) or 17(e33)